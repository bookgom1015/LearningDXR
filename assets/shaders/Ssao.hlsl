...
float4 PS(VertexOut pin) : SV_Target {
	...
	float3 n = mul(gNormalMap.Sample(gsamPointClamp, pin.TexC).xyz, (float3x3)gView);
	...
	float3 randVec = 2.0f * gRandomVectorMap.Sample(gsamLinearWrap, 4.0f * pin.TexC).rgb - 1.0f;
